...
namespace DecoratorPatternStarbuzzExample
{
    public abstract class CondimentDecorator : Beverage
    {
        ...
        //Reason: when we do Beverage BB = new Mocha(BB); - we actually have a beverage object, BB is a Beverage object, not a Condiment Decorator obj
        //[NOT a CondimentDecorator object, SO WE CANT DO BB.TestFunc() as it doesnt belong to Beverage class] - Hence,we couldnt have named this function other than GetDescription()
